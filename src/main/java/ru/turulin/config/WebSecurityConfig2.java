 ...
 *
 *  Дока Spring предлагает использовать лямбда выражения для конфигурации бинов.
 *  Но тогда придется обрабатывать некоторые исключения прямо в блоке лямбды,
 *  что уменьшает читабельность.
 *
